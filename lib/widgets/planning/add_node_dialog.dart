...
/// Dialog for creating a new planning node
class AddNodeDialog extends StatefulWidget {
  final String? parentId;

  const AddNodeDialog({super.key, this.parentId});
...
class _AddNodeDialogState extends State<AddNodeDialog> {
  ...
  PlanningNodeType _selectedType = PlanningNodeType.task;
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Text(
                    widget.parentId != null ? 'Add Child Node' : 'Create Node',
  ...
  Future<void> _createNode() async {
    ...
    if (mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('${_selectedType.name} created'),
